...
@media(max-width:768px){{.reihana-title{{font-size:1.5rem!important;letter-spacing:4px;}}.msg-reihana,.msg-user{{padding:10px 12px;font-size:0.93rem;}}.dash-grid{{grid-template-columns:repeat(2,1fr);}}}}
